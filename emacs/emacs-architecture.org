#+TITLE: Emacs Architecture Overview
#+AUTHOR: The Emacs Collective
#+DATE: [2025-10-31 Fri]
#+DESCRIPTION: A comprehensive guide to Emacs architecture, components, and design principles
#+STARTUP: overview
...
[[file:diagrams/component-architecture.png]]

Source: [[file:diagrams/component-architecture.puml]]
*** Event Flow Sequence Diagram
[[file:diagrams/event-flow.png]]

Source: [[file:diagrams/event-flow.puml]]
*** Layered Architecture Diagram
[[file:diagrams/layered-architecture.png]]

Source: [[file:diagrams/layered-architecture.puml]]
*** Buffer-Window-Frame Relationships
[[file:diagrams/buffer-window-frame-relationships.png]]

Source: [[file:diagrams/buffer-window-frame-relationships.puml]]
*** Extension Mechanism Diagram
[[file:diagrams/extension-mechanisms.png]]

Source: [[file:diagrams/extension-mechanisms.puml]]
