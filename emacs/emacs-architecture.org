...
Source: [[file:component-architecture.puml]]
*** Event Flow Sequence Diagram
[[file:event-flow.png]]

Source: [[file:event-flow.puml]]
*** Layered Architecture Diagram
[[file:layered-architecture.png]]

Source: [[file:layered-architecture.puml]]
*** Buffer-Window-Frame Relationships
[[file:buffer-window-frame-relationships.png]]

Source: [[file:buffer-window-frame-relationships.puml]]
*** Extension Mechanism Diagram
[[file:extension-mechanisms.png]]

Source: [[file:extension-mechanisms.puml]]
